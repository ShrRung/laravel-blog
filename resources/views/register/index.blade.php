...
<div class="container">
    ...
    <form class="form-signin" method="POST" action="/register">
        ...
        <input type="password" name="password" id="inputPassword" class="form-control" placeholder="输入密码" value="{{ old('password') }}" required>
        <label class="sr-only">重复密码</label>
        <input type="password" name="password_confirmation" class="form-control" placeholder="重复输入密码" value="{{ old('password_confirmation') }}" required>
