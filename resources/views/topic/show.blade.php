...
@section("content")
    ...
    <div class="col-sm-8">
            <blockquote>
                ...
                <button class="btn btn-default topic-submit"  data-toggle="modal" data-target="#topic_submit_modal" topic-id="{{$topics->id}}" _token="{{csrf_token()}}" type="button">投稿</button>
            </blockquote>
        </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="/topic/{{$topics->id}}/submit" method="post">
